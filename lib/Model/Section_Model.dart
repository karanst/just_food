...
import 'package:entermarket_user/Model/User.dart';
...
Map? permissions;
  ...
  Product(
      ...
      this.gurantee,
        ...
        this.latitude,this.longitude,this.delivery_tiem,
        this.category_ids,
        this.seller_mobile,
        this.seller_whatsapp
      });
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    return new Product(
      ...
      seller_mobile: json["mobile"],
      seller_whatsapp: json["whatsapp_number"],

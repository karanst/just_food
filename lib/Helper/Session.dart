...
import 'package:entermarket_user/Screen/Favorite.dart';
import 'package:entermarket_user/Screen/Login.dart';
import 'package:entermarket_user/Screen/Search.dart';
import 'package:entermarket_user/Screen/starting_view/feature_order.dart';
import 'package:entermarket_user/Screen/starting_view/pharmacy_order.dart';
...
String calculateDistance(late1, lone1, late2, lone2){
  ...
  if(late1!=null&&late2!=null&&lone1!=null&&lone2!=null&&late1!=""&&late2!=""&&lone1!=""&&lone2!=""){
    lat1 = double.parse(late1);
    lat2 = double.parse(late2);
    lon1 = double.parse(lone1);
    lon2 = double.parse(lone2);
  }else{
    return "0.0 km";
  }

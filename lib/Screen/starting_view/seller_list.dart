...
import 'package:entermarket_user/Screen/Cart.dart';
import 'package:entermarket_user/Screen/HomePage.dart';
import 'package:entermarket_user/Screen/Login.dart';
import 'package:entermarket_user/Screen/Manage_Address.dart';
...
import 'package:entermarket_user/Screen/starting_view/restaurent_product.dart';
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned.directional(
              ...
              child: widget.name!.toLowerCase().contains("rest")?InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SellerProfile(
                            ...
                            sellerRating: vendorList[index].rating,
                            sellerImage: "https://alphawizztest.tk/justfoodz/"+vendorList[index].logo,
                            sellerName: vendorList[index].username.toString(),
                            sellerID: vendorList[index].userId,
                            storeDesc: vendorList[index].storeDescription,
                            sellerMobile: vendorList[index].mobile,
                          )));
                },
                child: Card(
                  elevation: 1,
  ...
  //  if (CUR_USERID != null) parameter[USER_ID] = CUR_USERID!;
    ...
    apiBaseHelper.postAPICall(widget.name.toString().toLowerCase().contains("rest")?getRestApi:getProductApi, parameter).then((getdata) {
      ...
      if (!error) {
        ...
        var data = getdata["data"];
        for(var v in data){
          tempList.add(new VendorModel.fromJson(v));
        }
